          ...
          <div class="inline-block min-w-full py-2 sm:px-6 lg:px-8">
            <div class="overflow-hidden">
              ...
              <table className="min-w-full text-left text-sm font-light">
                <thead className="sticky-header border-b font-medium dark:border-neutral-500">
                  <tr>
                    <th scope="col" class="px-6 py-4">Particulars</th>
                    <th scope="col" class="px-6 py-4">Previous Year(2023)</th>
                    <th scope="col" class="px-6 py-4">January-March-2023(1st-Q)</th>
                    <th scope="col" class="px-6 py-4">April-June-2023 (2nd-Q)</th>
                    <th scope="col" class="px-6 py-4">July-September-2023(3rd-Q)</th>
                    <th scope="col" class="px-6 py-4">October-December-2023(4th-Q)</th>
                    <th scope="col" class="px-6 py-4">Current-Year(2023)</th>
                  </tr>
                </thead>
